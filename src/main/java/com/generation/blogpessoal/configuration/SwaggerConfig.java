...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
		 ...
		 */
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - BootCamp Generation Brasil, Jonathan")
						.version("v0.0.1")
						.license(new License().name("Generation Brasil").url("https://brazil.generation.org/"))
						.contact(new Contact().name("Jonathan Henrique").url("https://www.linkedin.com/in/jonathan-henrique-/")
